...
// const modules = [
//   { title: "Emisor", icon: emisor, route: "/Schedule" },
//   { title: "Signos", icon: sign, route: "/" },
//   { title: "Consultorio", icon: consult, route: "/" },
//   { title: "Hospital", icon: hospital, route: "/" },
//   { title: "Otondología", icon: dental, route: "/" },
//   { title: "Óptica", icon: optic, route: "/" },
//   { title: "Farmacia", icon: pharmacy, route: "/" },
//   { title: "Inventario", icon: inventory, route: "/" },
//   { title: "Example", icon: example, route: "/" },
//   // { title: "Example", icon: example },
//   // { title: "Example", icon: example },
//   // { title: "Example", icon: example },
// ];
