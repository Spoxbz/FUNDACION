 ...
 * * Este modal form es usado por ConfOfficePage.tsx --> C:\Users\Usuario\Desktop\TESIS\DEVELOPMENT\FUNDACION\fhe-app\src\pages\admin\ConfOfficePage.tsx
 * * Este modal form usa la funcion deleteOffice declarada en employeeService.tsx
 */
...
interface DeleteDialogProps {
  office: Offices | null; // Empleado a eliminar
  onDelete: (officeId: number) => void; // Función para eliminar
  loading?: boolean; // Estado de carga
}

export default function DeleteDialogOffice({ office, onDelete, loading }: DeleteDialogProps) {
  ...
  const handleConfirmDelete = () => {
    if (office) {
      onDelete(office.office_id); // Llamar a la función de eliminación con el ID del empleado
    }
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="dialog-description">
            {office && `¿Estás seguro de que deseas eliminar el "${office.office_name}"?`}
          </DialogContentText>
        </DialogContent>
        <DialogActions>
